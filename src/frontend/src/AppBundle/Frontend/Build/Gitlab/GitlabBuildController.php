...
class GitlabBuildController
{
    ...
    public function createAction(Request $request, $id)
    {
        ...
        $form = $this->formFactory->create(GitlabBuildForm::class, null, ['api' => $api, 'project' => $project]);
        ...
        return $this->templating->renderResponse('frontend/build/create_gitlab.html.twig', [
    ...
    private function normalizeBuildData(GitlabApi $api, $serverIdentity, array $formData)
    {
        try {
        ...
        return [
            ...
            'commit_range' => sprintf('%s...%s', $formData['commit'], $formData['commit']),
